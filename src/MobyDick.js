  ...
  return (
    <div className="font-lora leading-relaxed">
      ...
      <p className="mb-7">
        ...
        it. Let the most absentminded of men be plunged in his deepest
      ...
      <p className="mb-7">
        ...
        way, reaching to overlapping spurs of mountains bathed in their
      ...
      <p className="mb-7">
        ...
        a rag unless you have something in it. Besides, passengers get
      ...
      <p className="mb-7">
        ...
        exercise and pure air of the forecastle deck. For as in this world, head
        winds are far more prevalent than winds from astern (that is, if you
        never violate the Pythagorean maxim), so for the most part the Commodore
        on the quarter-deck gets his atmosphere at second hand from the sailors
        on the forecastle. He thinks he breathes it first; but not so. In much
        the same way do the commonalty lead their leaders in many other things,
        at the same time that the leaders little suspect it. But wherefore it
        was that after having repeatedly smelt the sea as a merchant sailor, I
        ...
        this whaling voyage, formed part of the grand programme of Providence
        that was drawn up a long time ago. It came in as a sort of brief
        interlude and solo between more extensive performances. I take it that
        this part of the bill must have run something like this:
      </p>
      <p className="mb-7">
        "grand contested election for the presidency of the united states.
      </p>
      <p className="mb-7">"whaling voyage by one ishmael.</p>
      <p className="mb-7">"bloody battle in afghanistan."</p>
      <p className="mb-7">
        ...
        easy parts in genteel comedies, and jolly parts in farces--though I
